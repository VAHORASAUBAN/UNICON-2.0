...
class _StudentListScreenState extends State<StudentListScreen> {
  ...
  void _generateStudents() {
    ...
    for (String course in courses) {
      for (String sem in semesters) {
        for (String div in divisions) {
          for (int i = 1; i <= 50; i++) {  // ✅ Reduced student count for better performance
            allStudents.add(Student(
              name: "Student $i ($course - Sem $sem - Div $div)",
              course: course,
              sem: sem,
              div: div,
            ));
    ...
    print("✅ Total students added: ${allStudents.length}"); // DEBUG: Check student generation
  }
  ...
  void _applyFilters() {
    setState(() {
      ...
      print("✅ Filtered students count: ${filteredStudents.length}"); // DEBUG: Check filtered students
      currentPage = 0;
    });
  }
  ...
  // ✅ Fixed dropdown background to white
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildDropdown("Sem", ["All", "1", "2", "3"], selectedSemester, (value) { // ✅ Only 3 semesters
            selectedSemester = value!;
            _applyFilters();
          }),
          _buildDropdown("Div", ["All", "A", "B", "C"], selectedDivision, (value) {
  ...
  Widget _buildDropdown(String label, List<String> items, String selectedValue, Function(String?) onChanged) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,  // ✅ Dropdown background is white
